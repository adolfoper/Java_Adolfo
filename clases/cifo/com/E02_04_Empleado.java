...
public class E02_04_Empleado {
	...
	//
	public E02_04_Empleado(String nombre, String dni, int sueldo) throws Error_Valida {
		   if (nombre.equals(""))
			   throw new Error_Valida("Nombre incorrecto");
		   if (dni.equals(""))
			   throw new Error_Valida("Dni incorrecto");
...
//
	public E02_04_Empleado(String nombre, String dni) throws Error_Valida {
	   if (nombre.equals(""))
	       throw new Error_Valida("Nombre incorrecto");
	   if (dni.equals(""))
	       throw new Error_Valida("Dni incorrecto");
